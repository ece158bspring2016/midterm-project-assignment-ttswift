...
class ParkMapViewController: UIViewController {
    ...
    //initialize the park property using MagicMountain.plist by default
  ...
  override func viewDidLoad() {
    ...
    //creates a latitude delta, which is the distance from the top left coordinate of the park’s property to the bottom right coordinate of the park’s property
  ...
  //user should choose to show the map overlay
  // loadSelectedOptions() removes any annotations and overlays that may be present so that you don’t end up with duplicate renderings
...
extension ParkMapViewController: MKMapViewDelegate{
    func mapView(mapView: MKMapView!, rendererForOverlay overlay: MKOverlay!) -> MKOverlayRenderer! {
        if overlay is ParkMapOverlay {
            let magicMountainImage = UIImage(named: "overlay_park.png")
